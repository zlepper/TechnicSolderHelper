...
`curl https://raw.githubusercontent.com/zlepper/TechnicSolderHelper/master/installer.sh | sh`, this will install the program in your home directory, though it can be changed in the script. 
